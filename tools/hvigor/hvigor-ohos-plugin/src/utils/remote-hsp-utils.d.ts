 ...
 * @param service
 */
export declare function getRemoteHspPathMap(service: ModuleTaskService | ProjectTaskService): Map<string, string>;
/**
 ...
 */
export declare function initSignRemoteHspMap(remoteHspPath: string, allRemoteHspPathMap: Map<string, RemoteHspOpt>): void;
