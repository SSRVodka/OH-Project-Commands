...
export { isWindows, isMac, isLinux, maxPathLength } from '@ohos/hvigor-common';
export { hash, hashFile } from './src/common/util/hash-util.js';
export { PathUtil } from './src/common/util/path-util.js';
export { getModuleIndex, setWorkerIdWithModule, getWorkerIdWithModule } from './src/common/util/math-util.js';
...
export { replaceBundleName } from './src/base/log/adaptor/fileLogger.js';
 ...
 * 增量声明装饰器
 */
export { Input, Inputs, InputFile, InputFiles, OutputFile, OutputFiles } from './src/base/incremental-decorator/index.js';
